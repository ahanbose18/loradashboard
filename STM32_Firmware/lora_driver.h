...
/**************************************************************
 * @brief  Do a request to get the LoRaWAN & firmware version of the modem (slave)
 * @brief  For USI modem with FW version <= 2.7 --> only LoRaWAN version
 * @brief  For USI modem with FW Version > 2.7 --> LoRaWAN & FW version together
 ...
 * @brief  Only Available for USI modem with FW version <= 2.7
